...
#define _doc_FnDagNode_addChild \
    "Makes this node a parent of `child`."

#define _doc_FnDagNode_child \
    "Returns the specified child of this node."

#define _doc_FnDagNode_childCount \
    "Returns the number of nodes which are children of this one."

#define _doc_FnDagNode_getConnectedSetsAndMembers \
    "Returns a tuple containing an array of sets and an array of\n"\
    "the components of the DAG object which are in those sets.\n"\
    "If the entire object is in a set, then the corresponding entry in\n"\
    "the comps array will have no elements in it.\n"

#define _doc_FnDagNode_dagPath \
    "Returns the DAG path to which this function set is attached.\n"\
    "\n"\
    "Raises a TypeError if the function set is attached to an MObject\n"\
    "rather than a path."

#define _doc_FnDagNode_dagRoot \
    "Returns the root node of the first path leading to this node."

#define _doc_FnDagNode_duplicate \
    "Duplicates the DAG hierarchy rooted at the current node."

#define _doc_FnDagNode_fullPathName \
    "Returns the full path of the attached object, from the root of the DAG\n"\
    "on down."

#define _doc_FnDagNode_getAllPaths \
    "Returns all of the DAG paths which lead to the object to which\n"\
    "this function set is attached."

#define _doc_FnDagNode_getPath \
    "Returns the DAG path to which this function set is attached, or the\n"\
    "first path to the node if the function set is attached to an MObject."

#define _doc_FnDagNode_hasChild \
    "Returns True if the specified node is a child of this one."

#define _doc_FnDagNode_hasParent \
    "Returns True if the specified node is a parent of this one."

#define _doc_FnDagNode_instanceCount \
    "Returns the number of instances for this node."

#define _doc_FnDagNode_isChildOf \
    "Returns True if the specified node is a parent of this one."

#define _doc_FnDagNode_isInstanced \
    "Returns True if this node is instanced."

#define _doc_FnDagNode_isInstancedAttribute \
    "Returns True if the specified attribute is an instanced attribute of\n"\
    "this node."

#define _doc_FnDagNode_isParentOf \
    "Returns True if the specified node is a child of this one."

#define _doc_FnDagNode_parent \
    "Returns the specified parent of this node."

#define _doc_FnDagNode_parentCount \
    "Returns the number of parents this node has."

#define _doc_FnDagNode_partialPathName \
    "Returns the minimum path string necessary to uniquely identify\n"\
    "the attached object."

#define _doc_FnDagNode_removeChild \
    "Removes the child, specified by MObject, reparenting it under the world."

#define _doc_FnDagNode_removeChildAt \
