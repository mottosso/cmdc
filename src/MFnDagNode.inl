#define _doc_FnDagNode_create R"pbdoc(Creates a new DAG node of the specified type, with the given name.\
...
#define _doc_FnDagNode_addChild R"pbdoc(Makes this node a parent of `child`.)pbdoc"

#define _doc_FnDagNode_child R"pbdoc(Returns the specified child of this node.)pbdoc"

#define _doc_FnDagNode_childCount R"pbdoc(Returns the number of nodes which are children of this one.)pbdoc"

#define _doc_FnDagNode_getConnectedSetsAndMembers R"pbdoc( Returns a tuple containing an array of sets and an array of the\
...
#define _doc_FnDagNode_dagPath R"pbdoc(Returns the DAG path to which this function set is attached. Raises a TypeError if the function set is attached to an MObject rather than a path.)pbdoc"

#define _doc_FnDagNode_dagRoot R"pbdoc(Returns the root node of the first path leading to this node.)pbdoc"

#define _doc_FnDagNode_duplicate R"pbdoc(Duplicates the DAG hierarchy rooted at the current node.)pbdoc"

#define _doc_FnDagNode_fullPathName R"pbdoc(Returns the full path of the attached object, from the root of the DAG on down.)pbdoc"

#define _doc_FnDagNode_getAllPaths R"pbdoc(Returns all of the DAG paths which lead to the object to which this function set is attached.)pbdoc"

#define _doc_FnDagNode_getPath R"pbdoc(Returns the DAG path to which this function set is attached, or the first path to the node if the function set is attached to an MObject.)pbdoc"

#define _doc_FnDagNode_hasChild R"pbdoc(Returns True if the specified node is a child of this one.)pbdoc"

#define _doc_FnDagNode_hasParent R"pbdoc(Returns True if the specified node is a parent of this one.)pbdoc"

#define _doc_FnDagNode_instanceCount R"pbdoc(Returns the number of instances for this node.)pbdoc"

#define _doc_FnDagNode_isChildOf R"pbdoc(Returns True if the specified node is a parent of this one.)pbdoc"

#define _doc_FnDagNode_isInstanced R"pbdoc(Returns True if this node is instanced.)pbdoc"

#define _doc_FnDagNode_isInstancedAttribute R"pbdoc(Returns True if the specified attribute is an instanced attribute of this node.)pbdoc"

#define _doc_FnDagNode_isParentOf R"pbdoc(Returns True if the specified node is a child of this one.)pbdoc"

#define _doc_FnDagNode_parent R"pbdoc(Returns the specified parent of this node.)pbdoc"

#define _doc_FnDagNode_parentCount R"pbdoc(Returns the number of parents this node has.)pbdoc"

#define _doc_FnDagNode_partialPathName R"pbdoc(Returns the minimum path string necessary to uniquely identify the attached object.)pbdoc"

#define _doc_FnDagNode_removeChild R"pbdoc(Removes the child, specified by MObject, reparenting it under the world.)pbdoc"

#define _doc_FnDagNode_removeChildAt R"pbdoc(Removes the child, specified by index, reparenting it under the world.)pbdoc"

#define _doc_FnDagNode_setObject R"pbdoc(Attaches the function set to the specified node or DAG path.)pbdoc"

#define _doc_FnDagNode_setObject R"pbdoc(Attaches the function set to the specified node or DAG path.)pbdoc"

#define _doc_FnDagNode_transformationMatrix R"pbdoc(Returns the object space transformation matrix for this DAG node.)pbdoc"
